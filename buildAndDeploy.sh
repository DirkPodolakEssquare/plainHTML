...
driftbottleBaseAPIUrl=$(jq -r .DriftbottleBackendStack.DriftbottleBaseAPIUrlOutputParameter outputsBackend.json)
cd ..
...
sed -i "s/###BASEAPIURL###/$driftbottleBaseAPIUrl/g" myConfig.js
